...
public class DbImplTest
{
    ...
    @Test
    public void testTooManyOpenFiles()
            throws Exception
    {
        long baseLine = getOpenFiles();
        Options options = new Options();
        options.maxOpenFiles(20);
        options.createIfMissing(true);
        DbImpl db = new DbImpl(options, databaseDir);
        for (int index = 0; index < 500000; index++) {
            String key = "Key LOOOOOOOOOOOOOOOOOONG KEY " + index;
            String value = "This is element " + index + "";
            db.put(key.getBytes("UTF-8"), value.getBytes("UTF-8"));
            long openFiles = getOpenFiles();
            if (openFiles - baseLine > 20) {
            System.out.println("Currently open files (should be <= 21): " + openFiles + ". Baseline: " + baseLine + ". Diff: " + (openFiles - baseLine));
            }
            // Some other files are open beside the tablecache, so assert for 30
            assertEquals(openFiles - baseLine <= 30, true);
        }

        for (int index = 0; index < 500000; index++) {
            String key = "Key LOOOOOOOOOOOOOOOOOONG KEY " + index;
            db.get(key.getBytes("UTF-8"));
            long openFiles = getOpenFiles();
            if (openFiles - baseLine > 20) {
            System.out.println("Currently open files (should be <= 21): " + openFiles + ". Baseline: " + baseLine + ". Diff: " + (openFiles - baseLine));
            }
